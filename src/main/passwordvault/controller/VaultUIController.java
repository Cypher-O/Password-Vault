...
public class VaultUIController {
    ...
    private void displayVault() {
        if (passwordVault.isEmpty()) {
            ...
            for (Map.Entry<String, String> entry : passwordVault.entrySet()) {
                ...
                String password = isPasswordVisible ? decryptPassword(encryptedPassword) : (encryptedPassword);
    ...
    private void togglePasswordVisibility() {
        isPasswordVisible = !isPasswordVisible;
        displayVault();
        toggleButton.setText(isPasswordVisible ? "Encrypt Passwords" : "Decrypt Passwords");
    }
